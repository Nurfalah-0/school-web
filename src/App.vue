...
<script setup>
import { ref } from 'vue';
import TopNav from './modules/portal/components/TopNav.vue';
import HeroSection from './modules/portal/components/HeroSection.vue';
import PartnersSection from './modules/portal/components/PartnersSection.vue';
import InfoSection from './modules/portal/components/InfoSection.vue';
import JobSection from './modules/portal/components/JobSection.vue';
import ApplySection from './modules/portal/components/ApplySection.vue';
import TimelineSection from './modules/portal/components/TimelineSection.vue';
import AlumniSection from './modules/portal/components/AlumniSection.vue';
