    ...
    public function updateProfile(Request $request)
    {
        try {
            $validated = $request->validate([
                ...
                'profile_page_title' => 'sometimes|nullable|string|max:255',
                'profile_page_content' => 'sometimes|nullable|string',
                'vision_page_intro' => 'sometimes|nullable|string',
                'vision_page_content' => 'sometimes|nullable|string',
                'mission_page_content' => 'sometimes|nullable|string',
